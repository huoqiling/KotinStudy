            ...
            parent.adapter.apply {
                registerAdapterDataObserver(object : RecyclerView.AdapterDataObserver() {
                    override fun onItemRangeInserted(positionStart: Int, itemCount: Int) {
                        ...
                        notifyItemRangeChanged(startPosition, getItemCount() - startPosition, 0)
                    }

                    override fun onItemRangeMoved(fromPosition: Int, toPosition: Int, itemCount: Int) {
                        notifyItemRangeChanged(min(fromPosition, toPosition), itemCount + 1, 0)
                    }

                    override fun onItemRangeRemoved(positionStart: Int, itemCount: Int) {
                        notifyItemRangeChanged(positionStart, getItemCount() - positionStart + 1, 0)
                    }
                })
            }
        }
